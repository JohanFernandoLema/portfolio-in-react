...
const Navbar = () => {
  ...
  return (
    <div className="fixed w-full h-[80px] flex justify-between items-center px-4 bg-[#0a192f] text-gray-300">
      ...
      {/* Hamburger */}
      {/* When it is above medium the hamburger icon will disappear */}
      ...
      <div className=" hidden lg:flex fixed flex-col top-[35%] left-0">
        <ul>
          ...
          <li className="w-[160px] h-[60px] flex justify-between ml-[-100px] hover:ml-[-10px] duration-300 bg-[#FA9500]">
            <a
              className="flex justify-between w-full items-center text-gray-300"
              href="/"
            >
          ...
          <li className="w-[160px] h-[60px] flex justify-between ml-[-100px] hover:ml-[-10px] duration-300 bg-[#8B94A3]">
            <a
              className="flex justify-between w-full items-center text-gray-300"
              href="/"
            >
